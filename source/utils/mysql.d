...
size_t mysql_escape_string(char* to, const(char)* from, size_t from_length);
size_t mysql_hex_string(char* to, const(char)* from, size_t from_length);
size_t mysql_real_escape_string(MYSQL* mysql, char* to, const(char)* from, size_t length);
size_t mysql_real_escape_string_quote(MYSQL* mysql, char* to, const(char)* from, size_t length, char quote);
...
bool mysql_stmt_send_long_data(MYSQL_STMT* stmt, uint param_number, const(char)* data, size_t length);
